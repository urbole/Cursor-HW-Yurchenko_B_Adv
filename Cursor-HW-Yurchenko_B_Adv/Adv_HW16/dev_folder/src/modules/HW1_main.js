...
export {
  applePriceKg, mangoPriceKg, kiwiPriceKg, banknote500UAH,
  discount, sumPrices, sumRoundedPrices, hundredsRoundedSumPrices,
  oddEvenCheck, change, meanPrices, toPay, income, myString
}
